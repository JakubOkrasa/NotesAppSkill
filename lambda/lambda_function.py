...
from custom_intents import GetNotesIntentHandler
from custom_intents import AddNoteIntentHandler
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome in notes app."
...
class HelpIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "If you want I can read your notes or create an new one. Just say 'read notes' or 'create note'"
...
sb.add_request_handler(GetNotesIntentHandler())
sb.add_request_handler(AddNoteIntentHandler())
